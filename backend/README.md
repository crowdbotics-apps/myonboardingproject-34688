...
## Project Structure
    ...
    ├── myonboardingproject_34688  # Django project configurations
...
1. Clone this repo and `cd myonboardingproject_34688`
...
2. Clone this repo and `cd myonboardingproject_34688`
